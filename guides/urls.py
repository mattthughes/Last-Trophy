...
from . import views
from .views import guide_detail_view, AddGuideView, EditGuideView, DeleteGuide, GuideNotApproved, GuideApproved, LikeView
...
urlpatterns = [
    ...
    path('like/<slug:slug>', LikeView, name='like_guide')
